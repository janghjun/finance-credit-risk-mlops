...
- [카드사 정책 저장소]는 공지사항/약관 크롤링 + 가상 정책 데이터셋 혼합으로 구축
  -> 빈파일 생성 문제로 인하여 **크롤링을 통한 데이터 수집의 내용을 api 활용한 데이터셋 수집**으로 내용 변경
...
| 개인 (Personal) |
| 목적 | 활용 API |
| 대출 규제(DISR) 적용 | 금융회사통계정보 → 국내은행정보 |
|금융상품 분석 | 금융상품기본정보 (서민금융상품, 보험, 연금 등) |
| 부채/금융활동 보조 | 금융회사정보 (금융회사 기본/재무) |
| 법인 (Corporate) |
| 목적 | 활용 API |
| LEX 규제 적용	| 기업정보 (기업기본, 재무, 차입투자, 지배구조, 상장종목) |
| 신용/공시 데이터 | 공시정보 (기업공시) |
| 발급사 정책 연계 | 금융회사정보 (금융회사 기본/재무) |
| 소상공인 (SME) |
| 목적 | 활용 API |
| 정책금융/보증 반영 | 개인사업자정보 (기본, 재무, 금융, 평가) |
| 보증/지원 실적 | 금융회사통계정보 (서민금융지원실적, 신용카드사정보) |
|시장 활동 보조 | 금융상품기본정보 (서민금융상품, 펀드, 연금) |
| 공통 보조 |
|목적 |	활용 API |
| 시장지표 | 시세정보 (주식·채권·지수·파생상품) |
| 금융회사 정책 | 금융회사정보 (기본/재무) |
| 금융회사 공시	| 공시정보 (금융회사공시) |
```
